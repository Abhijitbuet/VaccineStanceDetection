...
def load_api():
    ...
    consumer_key = 'UkircbgKEyvOvJyfeb0YWbBv8'
    consumer_secret = 'ZEbjcJYf01FDiKn5mlPZY4NIiADpY0Tc1UGVLm6hUnf6V0a0fB'
    access_token = ''
    access_secret = ''
...
def main():
    ...
    ''' search variables: '''
    search_phrases = ['#depopulation',
                      'NewWorldOrder',
                      '#covidvaxexposed',
                      '#PLANdemia',
                      '#vaccinekills',
                      '#plandemic','#notocoronavirusvaccines',
                       '#mybodymychoice',
                      '#iwillnotcomply', '#pharmagreed',
                      '#kungflu',
                      '#greatreset',
                      '#covidiots',
    ...
    max_tweets = 500  # number of tweets per search (will be
